...
/// @notice Utility contract for executing a permit signature to update the approval status in an Rae contract
abstract contract SelfPermit {
    ...
    function selfPermit(
        ...
        IRae(_token).permit(msg.sender, address(this), _id, _approved, _deadline, _v, _r, _s);
    }
    ...
    function selfPermitAll(
        ...
        IRae(_token).permitAll(msg.sender, address(this), _approved, _deadline, _v, _r, _s);
    }
}
