...
contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    function _removeTokenFromAllTokensEnumeration(uint256 tokenId) private {
        ...
        // This also deletes the contents at the last position of the array
        /* _allTokens.length--; */
        delete _allTokens[_allTokens.length - 1];
...
contract ERC721Full is ERC721Enumerable, ERC721Metadata {
    ...
    function _mint(address to, uint256 tokenId) internal override(ERC721Enumerable, ERC721) {
        super._mint(to, tokenId);
    }
...
contract WrappedPunk is Ownable, ERC721Full, Pausable {
     ...
     * @dev Initializes the contract settings
     */
    constructor(address punkContract_) ERC721Full("Wrapped Cryptopunks", "WPUNKS") {
